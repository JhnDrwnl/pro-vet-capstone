<template>
    <div class="bg-white p-6">
      <div class="mb-6">
        <h2 class="text-2xl font-medium text-gray-900">{{ activeTab === 'categories' ? 'Categories Management' : 'Services Management' }}</h2>
        <p class="text-gray-500 mt-1">{{ activeTab === 'categories' ? 'Manage service categories and classifications' : 'Manage veterinary services and requirements' }}</p>
      </div>
          ...
          <div class="border border-gray-200 rounded-lg overflow-hidden">
            <table class="min-w-full divide-y divide-gray-200">
              ...
              >
                ...
                <template v-else>
                  <template v-for="service in paginatedItems" :key="service.id">
